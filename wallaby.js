...
module.exports = function (wallaby) {
  ...
  var webpackPostprocessor = wallabyWebpack({
    ...
    resolve: {
      ...
      alias: {
        '@mitek': path.join(wallaby.projectCacheDir, 'src/mitek'),
        '@products/core': path.join(wallaby.projectCacheDir, 'src/core')
      }
    },
    node: {
      fs: 'empty',
  ...
  return {
    files: [
      ...
      {pattern: 'src/mitek/**/*.js', load: false, instrument: false},
    ...
    tests: [
      ...
      {pattern: 'src/mitek/*spec.ts', ignore: true}
    ],
